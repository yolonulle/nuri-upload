                    ...
                    try {
                        ...
                        if (!error) {
                            ...
                            for (int i = 0; i < jArry.length(); i++) {
                                ...
                                int pnumber = performance.getInt("performance_no");
                                int artist = performance.getInt("artist_no");
                                String title = performance.getString("title");
                                ...
                                // Performance class 생성, 리스트에 추가한다.
                                Performance p = new Performance(pnumber, artist, title, content, region, genre, pdate, ptime);
                                performanceList.add(p);
